...
Background::Background(Scene* scene)
	...
	Scale(1.f);
	// SpriteComponent* bg0 = new SpriteComponent(this, 0, 1);
	//bg0->SetTexture("Bg0");
	SpriteComponent* bg1 = new SpriteComponent(this, 0, 1);
	bg1->SetTexture("Bg0");
	SpriteComponent* bg2 = new SpriteComponent(this, 1, 1);
	bg2->SetTexture("Bg1");
	SpriteComponent* bg3 = new SpriteComponent(this, 2, 1);
	bg3->SetTexture("Bg2");
	SpriteComponent* bg4 = new SpriteComponent(this, 3, 1);
	bg4->SetTexture("Bg3");
	SpriteComponent* bg5 = new SpriteComponent(this, 4, 1);
	bg5->SetTexture("Bg4");
	SpriteComponent* bg6 = new SpriteComponent(this, 14, 1);
	bg6->SetTexture("Bg5");
